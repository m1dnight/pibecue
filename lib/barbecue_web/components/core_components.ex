defmodule BarbecueWeb.CoreComponents do
  @moduledoc """
    ...
    <div phx-feedback-for={@name}>
      <label class="flex items-center gap-4 text-sm leading-6 text-zinc-600">
        ...
        <input
          ...
          value="true"
          checked={@checked}
          class="sr-only peer peer-checked"
          {@rest}
        />
        {@label}
      </label>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BarbecueWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BarbecueWeb.Gettext, "errors", msg, opts)
    end
  end
