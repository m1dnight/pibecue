...
config :barbecue,
  thermocouple: Barbecue.IO.Thermocouple.Real,
  fan_speed: Barbecue.IO.Fanspeed.Real

config :barbecue,
  ecto_repos: [Barbecue.Repo]

config :barbecue, Barbecue.Repo,
  database: "/data/barbecue.db",
...
config :barbecue, BarbecueWeb.Endpoint,
  # Code Reloader and watchers cannot be used on target
  code_reloader: false,
  watchers: []

# Use Ringlogger as the logger backend and remove :console.
# See https://hexdocs.pm/ring_/Users/christophe/Documents/Code/nerves/pibecue/lib/barbecue/io /Users/christophe/Documents/Code/nerves/pibecue/lib/barbecue/thermometer.exlogger/readme.html for more information on
